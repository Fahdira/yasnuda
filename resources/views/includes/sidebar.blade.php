    <aside :class"{ '-translate-x-full': !open }" class="z-10 bg-gray-900 text-white w-64 p-4 absolute inset-y-0 left-0 md:relative -translate-x-full md:-translate-x-0 overflow-y-auto transition ease-in-out duration-200">
        <div class="flex items-center justify-between mb-6">
            <div class="flex-1 flex justify-center">
                <img alt="School Logo" class="h-12 w-12" height="50" src="{{ asset('images/logo/logo.png') }}" width="50"/>
            </div>
        ...
        <nav>
         <ul>
          <li class="mb-4">
           <a class="flex items-center p-2 text-white hover:bg-gray-700 rounded" href="{{ route('dashboard') }}">
